...
[在线体验](https://betaer.github.io/AISignal/) · [反馈问题](https://github.com/betaer/AISignal/issues) · [发布物料](docs/launch-kit.md)
...
| 脱敏分享 | 文本摘要、结果图片 | 分享评分、判定口径和风险类别，不带 IP / DNS / 指纹值 |
...
| 复制诊断摘要 / 分享结果图 | 否 | 文本和图片只包含评分、判定口径和风险类别，不复制 IP、DNS、组织和指纹值 |

## 快速使用

1. 打开 [https://betaer.github.io/AISignal/](https://betaer.github.io/AISignal/)。
2. 等待自动检测完成，先看综合信任分和风险摘要。
3. 展开红色或黄色项目，查看详细解释和规避建议。
4. 需要交流时开启“隐私模式”，或点击“复制诊断摘要 / 分享结果图”分享不含敏感值的结果。
...
- Website：`https://betaer.github.io/AISignal/`
